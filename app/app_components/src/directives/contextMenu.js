(function (angular) {
	 ...
	 *      $scope.contextMenu = {
                    list:[
                        ...
                        [
                            {name:'Upload new file',list:[ //subitems
                                {name:'Add new Subfile',icon:'fa fa-plus-circle', call:"SubAddFolder"},
                                {name:'Delete Subfile',icon:'fa fa-minus-circle',  call:"SubDeleteFolder"}
                            ]}
                        ]
                    ],
